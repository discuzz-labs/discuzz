...
describe("Sign-Up Navigation Test", () => {
  ...
  it("should navigate to /verify if the /sign-up page was visited and userToken has verified set to false", () => {
  ...
  it("should navigate to /dashboard if the /sign-up page was visited and userToken has verified set to true", () => {
    // Set the userToken in localStorage with verified: false
    cy.window().then((window) => {

...
export default function VerifyLayout() {
  ...
  const {isError, error, isSuccess, isPending, mutate } = useMutation<boolean, Error, void>({
  ...
  return (
    <div className="relative w-full h-[100vh] flex flex-col items-center justify-center">
      ...
      {isSuccess && <p className="flex items-center gap-5"><Check /> {SUCCESS.VERIFICATION_SUCCESS_EMAIL_SENT} </p> }
      <div className="w-1/2">   
      <AuthForm

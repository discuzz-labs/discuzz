...
export enum ERROR {
  ...
  VERIFICATION_FAILED_Verification_EMAIL_CANNOT_BE_SEND = "We cannot send you the Verificationation email. Try later.",
...
export enum SUCCESS {
  VERIFICATION_SUCCESS_VerificationATION_EMAIL_SEND = "We sended you a Verificationation email. Check the spam folder too.",
